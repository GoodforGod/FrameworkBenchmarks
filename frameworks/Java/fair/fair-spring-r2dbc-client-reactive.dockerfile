...
RUN gradle java-spring-r2dbc-client-reactive:bootJar --no-daemon
...
COPY --from=builder /home/gradle/src/java-spring-r2dbc-client-reactive/build/libs/java-spring-r2dbc-client-reactive.jar /app/app.jar
