...
RUN gradle java-helidon-mp-jpa-repository:distTar --no-daemon
...
COPY --from=builder /home/gradle/src/java-helidon-mp-jpa-repository/build/distributions/application.tar /app/application.tar
