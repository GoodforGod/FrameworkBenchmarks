...
RUN gradle java-micronaut-jpa-repository-reactive:distTar --no-daemon
...
COPY --from=builder /home/gradle/src/java-micronaut-jpa-repository-reactive/build/distributions/application.tar /app/application.tar
