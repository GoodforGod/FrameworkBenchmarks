...
class BenchmarkIntegrationTest {
    ...
    static void setup() throws Exception {
        postgres = new PostgreSQLContainer<>(DockerImageName.parse("postgres:18.4-alpine"))
                ...
                .waitingFor(Wait.forLogMessage(".*database system is ready.*", 2));

        app = new GenericContainer<>(new ImageFromDockerfile("fair-spring-jdbc-template").withDockerfile(Paths.get("Dockerfile").toAbsolutePath()))
