...
RUN gradle java-micronaut-jpa-repository:distTar --no-daemon
...
COPY --from=builder /home/gradle/src/java-micronaut-jpa-repository/build/distributions/application.tar /app/application.tar
