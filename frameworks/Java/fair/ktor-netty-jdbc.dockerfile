...
RUN gradle kotlin-ktor-netty-jdbc:distTar --no-daemon
...
COPY --from=builder /home/gradle/src/kotlin-ktor-netty-jdbc/build/distributions/application.tar /app/application.tar
