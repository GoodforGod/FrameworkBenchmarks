...
#RUN gradle java-kora2-jdbc-repository:distTar --no-daemon
...
#COPY --from=builder /home/gradle/src/java-kora2-jdbc-repository/build/distributions/application.tar /app/application.tar
COPY ./java-kora2-jdbc-repository/application.tar /app/application.tar
