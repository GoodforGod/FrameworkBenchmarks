...
class BenchmarkIntegrationTest {
    ...
    static void setup() throws Exception {
        ...
        app = new GenericContainer<>(new ImageFromDockerfile("fair-kotlin-kora1-vertx-repository-suspend").withDockerfile(Paths.get("Dockerfile").toAbsolutePath()))
                .withNetwork(NETWORK).withExposedPorts(8080)
                .withStartupTimeout(Duration.ofSeconds(30))
                .withLogConsumer(frame -> System.err.print(frame.getUtf8String()))
                .withEnv("POSTGRES_VERTX_URI", "postgresql://postgres:5432/postgres")
