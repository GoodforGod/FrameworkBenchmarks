...
RUN gradle kotlin-ktor-cio-jdbc-driver:distTar --no-daemon
...
COPY --from=builder /home/gradle/src/kotlin-ktor-cio-jdbc-driver/build/distributions/application.tar /app/application.tar
