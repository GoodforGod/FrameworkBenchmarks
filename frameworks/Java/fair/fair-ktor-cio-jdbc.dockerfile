...
RUN gradle kotlin-ktor-cio-jdbc:distTar --no-daemon
...
COPY --from=builder /home/gradle/src/kotlin-ktor-cio-jdbc/build/distributions/application.tar /app/application.tar
