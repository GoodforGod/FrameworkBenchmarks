package org.springframework.benchmark.jdbc.controller;
...
import org.springframework.benchmark.jdbc.model.Message;
import org.springframework.benchmark.jdbc.model.World;
import org.springframework.benchmark.jdbc.repository.FortuneRepository;
import org.springframework.benchmark.jdbc.repository.WorldRepository;
import org.springframework.benchmark.jdbc.util.QueryUtils;
...
public class BenchmarksController {
    ...
    public ResponseEntity<String> fortunes() {
        ...
        for (Fortune fortune : fortunes) {
            html.append("<tr><td>").append(fortune.id()).append("</td><td>");
