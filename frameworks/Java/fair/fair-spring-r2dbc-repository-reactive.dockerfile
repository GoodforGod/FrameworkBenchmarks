...
RUN gradle java-spring-r2dbc-repository-reactive:bootJar --no-daemon
...
COPY --from=builder /home/gradle/src/java-spring-r2dbc-repository-reactive/build/libs/java-spring-r2dbc-repository-reactive.jar /app/app.jar
