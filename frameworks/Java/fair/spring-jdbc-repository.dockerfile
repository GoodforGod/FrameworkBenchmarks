...
RUN gradle java-spring-jdbc-repository:bootJar --no-daemon
...
COPY --from=builder /home/gradle/src/java-spring-jdbc-repository/build/libs/java-spring-jdbc-repository.jar /app/app.jar
