...
RUN gradle java-micronaut-jdbc-repository:distTar --no-daemon
...
COPY --from=builder /home/gradle/src/java-micronaut-jdbc-repository/build/distributions/application.tar /app/application.tar
