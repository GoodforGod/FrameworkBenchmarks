...
RUN gradle java-spring-jpa-repository:bootJar --no-daemon
...
COPY --from=builder /home/gradle/src/java-spring-jpa-repository/build/libs/java-spring-jpa-repository.jar /app/app.jar
